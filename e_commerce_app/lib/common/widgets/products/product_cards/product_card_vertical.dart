...
import 'package:e_commerce_app/common/widgets/common_shapes/container/rounded_container.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ///Thumbnail, Whishlist Button, Discount Icon
            TRoundedContainer(
              height: 180,
